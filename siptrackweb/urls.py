...
urlpatterns = patterns('siptrackweb.views',
    ...
    (r'^template/rule/update/(?P<oid>[^/]+)/$', 'template.rule_update'),
    (r'^template/rule/update/post/(?P<oid>[^/]+)/$', 'template.rule_update_post'),
    ...
    (r'^device/config/(?P<oid>[^/]+)/$', 'device.config.display'),
    (r'^device/config/add/(?P<parent_oid>[^/]+)/$', 'device.config.add'),
    (r'^device/config/add/post/(?P<parent_oid>[^/]+)/$', 'device.config.add_post'),
    (r'^device/config/delete/(?P<oid>[^/]+)/$', 'device.config.delete'),
    (r'^device/config/delete/post/(?P<oid>[^/]+)/$', 'device.config.delete_post'),
    (r'^device/config/all/(?P<oid>[^/]+)/$', 'device.config.display_all'),
    (r'^device/config/submit/(?P<oid>[^/]+)/$', 'device.config.submit'),
    (r'^device/config/submit/post/(?P<oid>[^/]+)/$', 'device.config.submit_post'),
    (r'^device/config/download/(?P<oid>[^/]+)/(?P<timestamp>[^/]+)/$', 'device.config.download'),
    
    (r'^device/config/template/(?P<oid>[^/]+)/$', 'device.config_template.display'),
    (r'^device/config/template/add/(?P<parent_oid>[^/]+)/$', 'device.config_template.add'),
    (r'^device/config/template/add/post/(?P<parent_oid>[^/]+)/$', 'device.config_template.add_post'),
    (r'^device/config/template/delete/(?P<oid>[^/]+)/$', 'device.config_template.delete'),
    (r'^device/config/template/delete/post/(?P<oid>[^/]+)/$', 'device.config_template.delete_post'),
    (r'^device/config/template/submit/(?P<oid>[^/]+)/$', 'device.config_template.submit'),
    (r'^device/config/template/submit/post/(?P<oid>[^/]+)/$', 'device.config_template.submit_post'),
    (r'^device/config/template/generate/(?P<oid>[^/]+)/$', 'device.config_template.generate'),
    (r'^device/config/template/download/(?P<oid>[^/]+)/$', 'device.config_template.download'),
